...
- 📗組合せ論の基礎的な教科書[しっかり学ぶ組合せ論のエッセンス](../textbook/)
- ⭐組合せ論の魅力的な話題を紹介する[月刊組合せ論 Natori](../natori/)
- 🔢バーチャル combinatorialist 早稲くみあがお届けする[くみあラボ](../kumialab/)
- 💕好奇心旺盛ないおりとしいなが数え上げを学ぶ部活[いーしー部！](../ec/)
- 🖼️組合せ論に現れる美しい図形を鑑賞できる[組合せ論美術館](../gallery/)
...
{{< timelineItem header="東京大学理学部数学科" badge="学士（理学）" icon="star" >}}
東京大学理学部数学科を卒業しました。当時の専門は有限群でした。
{{< /timelineItem >}}

{{< timelineItem header="東京大学大学院数理科学研究科" badge="修士（数理科学）" icon="star" >}}
東京大学大学院数理科学研究科の修士課程を修了しました。無限群、リー代数、頂点代数などいろいろなものを勉強しました。最終的に代数的組合せ論で修士論文を書きました。
{{< /timelineItem >}}

{{< timelineItem header="To be continued?" icon="lock" >}}
...
{{< timelineItem header="学校事務" icon="star" >}}
