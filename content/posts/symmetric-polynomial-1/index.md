...
- $e_{(4)}=m_{(1,1,1,1)}$
- $e_{(3,1)}=m_{(2,1,1)}+(m_{(1,1,1,1)}\text{の線形結合})$
- $e_{(2,2)}=m_{(2,2)}+(m_{(1,1,1,1)},m_{(2,1,1)}\text{の線形結合})$
- $e_{(2,1,1)}=m_{(3,1)}+(m_{(1,1,1,1)},m_{(2,1,1)},m_{(2,2)}\text{の線形結合})$
- $e_{(1,1,1,1)}=m_{(4)}+(m_{(1,1,1,1)},m_{(2,1,1)},m_{(2,2)},m_{(3,1)}\text{の線形結合})$

のように表せます。このような性質を三角性といいます。この性質から

- $m_{(1,1,1,1)}=e_{(4)}$
- $m_{(2,1,1)}=e_{(3,1)}+(e_{(4)}\text{の線形結合})$
- $m_{(2,2)}=e_{(2,2)}+(e_{(4)},e_{(3,1)}\text{の線形結合})$
- $m_{(3,1)}=e_{(2,1,1)}+(e_{(4)},e_{(3,1)},e_{(2,2)}\text{の線形結合})$
- $m_{(4)}=e_{(1,1,1,1)}+(e_{(4)},e_{(3,1)},e_{(2,2)},e_{(2,1,1)}\text{の線形結合})$
